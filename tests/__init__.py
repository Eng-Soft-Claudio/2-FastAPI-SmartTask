...
# --- Configuração do Loop de Eventos (Necessário para pytest-asyncio) ---
# Define o escopo do loop de eventos para toda a sessão de teste
...
async def test_async_client() -> AsyncGenerator[AsyncClient, None]:
    ...
    # transport=ASGITransport(app=fastapi_app) foi substituído por app=fastapi_app
